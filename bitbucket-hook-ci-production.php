...
class Deploy {
     ...
     * @var string
     */
    private $_root_dir = '/var/www/vhosts/contest-templates.ca';
     ...
     * @var string
     */
    private $_public_dir = '/var/www/vhosts/contest-templates.ca/httpdocs';
     ...
     * @var string
     */
    private $_repo_dir = '/var/www/vhosts/contest-templates.ca/contest-templates-PRODUCTION.git';
     ...
     * @var string
     */
    private $_ci_dir = '/var/www/vhosts/contest-templates.ca/contest-templates-codeigniter';
     ...
     * @var string
     */
    private $_backup_dir = '/var/www/vhosts/contest-templates.ca/httpdocs/.deployment/backups';
